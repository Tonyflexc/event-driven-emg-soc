...
An event detector that continuously monitors EMG activity.

A neural-network accelerator that performs gesture classification only when an event is active.
